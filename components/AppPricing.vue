...
<template>
	...
	<div class="d-flex align-center justify-center mx-auto pt-sm-9 pb-sm-8 py-4">
		<VLabel for="pricing-plan-toggle" class="me-2 font-weight-medium">Monthly</VLabel>
		...
		<div class="position-relative">
			<div class="pricing-save-chip position-absolute d-sm-block d-none">
				...
				<VChip size="small" color="primary" class="mt-n2">Save up to 10%</VChip>
			</div>
		...
		<VCol v-for="plan in pricingPlans" :key="plan.logo" v-bind="props">
			...
			<VCard flat border :class="plan.isPopular ? 'border-primary border-opacity-100' : ''">
				<VCardText class="text-end pt-4" style="block-size: 3.75rem">
					<!-- 👉 Popular -->
					<VChip v-show="plan.isPopular" color="primary" size="small">Popular</VChip>
				</VCardText>
