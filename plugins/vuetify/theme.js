export const staticPrimaryColor = "#2ab2a9";
export const staticPrimaryDarkenColor = "#40d5ce";
export const themes = {
	light: {
		dark: false,
		colors: {
	...
	dark: {
		...
		colors: {
			...
			"skin-bordered-background": "#1f2934",
			"skin-bordered-surface": "#313c46",
		...
		variables: {
			"code-color": "#d400ff",
			"overlay-scrim-background": "#1f2934",
