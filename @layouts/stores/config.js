...
export const cookieRef = (key, defaultValue) => {
	return useCookie(namespaceConfig(key), { default: () => defaultValue, secure: false, sameSite: "lax" });
};
export const useLayoutConfigStore = defineStore("layoutConfig", () => {
	...
	cookieRef("ces", 456);
	cookieRef("ces2", 234);
	cookieRef(`ces2`, null).value = layoutConfig.navbar.navbarBlur;
	console.log("执行");

	// cookieRef(`123测123`, null).value = layoutConfig.verticalNav.isVerticalNavCollapsed;
