...
<template>
	<div class="d-lg-block d-none">
		<VBtn icon class="app-customizer-toggler rounded-s-xl rounded-0" style="z-index: 1001" @click="isNavDrawerOpen = true">
		...
		>
			...
			<div class="customizer-heading d-flex align-center justify-space-between">
				<div>
					<h6 class="text-h6">{{ t("home.Theme Customizer") }}</h6>
					<p class="text-body-2 mb-0">{{ t("home.Customize & Preview in Real Time") }}</p>
				</div>
			...
			<PerfectScrollbar tag="ul" :options="{ wheelPropagation: false }">
				<!-- SECTION Theming -->
				<CustomizerSection :title="t('home.Theming')" :divider="false">
					<!-- 👉 Primary Color -->
					<div class="d-flex flex-column gap-2">
						<h6 class="text-h6">{{ t("home.Primary Color") }}</h6>
							...
							>
								...
								>
									<VIcon
										...
										:color="
											vuetifyTheme.current.value.colors.primary === customPrimaryColor ? 'rgb(var(--v-theme-on-primary))' : ''
										"
									/>
								</VBtn>
					...
					<div class="d-flex flex-column gap-3">
						<h6 class="text-h6">{{ t("home.Theme") }}</h6>
						...
						>
							<template #label="item">
								<span class="text-sm text-medium-emphasis mt-1">{{ t(`home.${item?.label}`) }}</span>
							</template>
					...
					<!-- 👉 Skin -->
					<div class="d-flex flex-column gap-3">
						<h6 class="text-h6">{{ t("home.Skins") }}</h6>
						...
						>
							<template #label="item">
								<span class="text-sm text-medium-emphasis">{{ t(`home.${item?.label}`) }}</span>
							</template>
						</CustomRadiosWithImage>
					</div>
					...
					<div
						...
						"
					>
						<VLabel for="customizer-semi-dark" class="text-h6 text-high-emphasis">{{ t("home.Semi Dark Menu") }}</VLabel>
				...
				<!-- SECTION LAYOUT -->
				<CustomizerSection :title="t('home.Layout')">
					<!-- 👉 Layouts -->
					<div class="d-flex flex-column gap-3">
						<CustomRadiosWithImage
							:key="currentLayout"
